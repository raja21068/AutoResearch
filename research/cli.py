...
from research.health import print_doctor_report, run_doctor, write_doctor_report
...
def cmd_run(args: argparse.Namespace) -> int:
    ...
    hitl_session = None
    try:
        from research.hitl.config import HITLConfig
        from research.hitl.session import HITLSession
        from research.hitl.presets import get_preset
    ...
    from research.pipeline.runner import execute_pipeline, read_checkpoint
    from research.pipeline.stages import Stage
    ...
    if hitl_config and hitl_config.enabled:
        try:
            ...
            from research.hitl.adapters.cli_adapter import CLIAdapter
...
def cmd_validate(args: argparse.Namespace) -> int:
    from research.config import validate_config
    import yaml
...
def cmd_project(args: argparse.Namespace) -> int:
    ...
    from research.project.manager import ProjectManager
...
def cmd_mcp(args: argparse.Namespace) -> int:
    ...
    if start:
        ...
        from research.mcp.tools import list_tool_names
...
def cmd_overleaf(args: argparse.Namespace) -> int:
    ...
    from research.overleaf.sync import OverleafSync
...
def cmd_serve(args: argparse.Namespace) -> int:
    ...
    try:
        from research.server.app import create_app
        import uvicorn
...
def cmd_wizard(args: argparse.Namespace) -> int:
    ...
    from research.wizard.quickstart import QuickStartWizard
...
def cmd_report(args: argparse.Namespace) -> int:
    from research.report import generate_report, write_report
...
def cmd_calendar(args: argparse.Namespace) -> int:
    ...
    from research.calendar.deadlines import ConferenceCalendar
    from research.calendar.planner import SubmissionPlanner
...
def cmd_skills(args: argparse.Namespace) -> int:
    ...
    from research.skills.loader import load_skill_from_skillmd, load_skills_from_directory
    from research.skills.registry import SkillRegistry
...
def cmd_attach(args: argparse.Namespace) -> int:
    ...
    from research.hitl.store import HITLStore
    from research.hitl.tui.panel import show_pipeline_status, show_intervention_log
    ...
    from research.hitl.intervention import WaitingState, PauseReason
    from research.hitl.adapters.cli_adapter import CLIAdapter
