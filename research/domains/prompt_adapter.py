...
from research.domains.detector import DomainProfile, is_ml_domain
...
def _build_adapter_registry() -> dict[str, type[PromptAdapter]]:
    ...
    try:
        ...
        pass
    try:
        from research.domains.adapters.security import SecurityPromptAdapter
        registry["security_"] = SecurityPromptAdapter
    except ImportError:
        pass
    try:
        from research.domains.adapters.math import MathPromptAdapter
