...
def _execute_experiment_design(
    ...
    *,
    ...
    try:
        from research.domains.detector import detect_domain as _detect_domain_adv
    ...
    if (
        ...
        try:
            from research.agents.benchmark_agent import BenchmarkOrchestrator
            from research.agents.benchmark_agent.orchestrator import (
    ...
    try:
        from research.hitl.workshops.baseline import BaselineNavigator, BaselineCandidate
