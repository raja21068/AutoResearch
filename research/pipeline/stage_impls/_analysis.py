...
from research.pipeline._domain import _detect_domain, _is_ml_domain
...
def _execute_result_analysis(
    ...
    *,
    ...
    from research.experiment.sandbox import extract_paired_comparisons as _extract_paired
    ...
    if llm is not None:
        ...
        from research.prompts import DEBATE_ROLES_ANALYSIS  # noqa: PLC0415
...
"""
    ...
    if config.experiment.figure_agent.enabled and llm is not None:
        try:
            from research.agents.figure_agent import FigureOrchestrator
            from research.agents.figure_agent.orchestrator import FigureAgentConfig as _FACfg
    ...
    if not _figure_plan_saved:
        try:
            from research.experiment.visualize import (
...
def _execute_research_decision(
    ...
    *,
    ...
    if _exp_sum_path and _exp_sum_path.is_file():
        try:
            from research.pipeline.stage_impls._paper_writing import _check_ablation_effectiveness
