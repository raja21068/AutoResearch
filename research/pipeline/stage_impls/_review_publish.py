...
from research.pipeline._domain import _detect_domain  # noqa: F401
...
def _get_collect_raw_experiment_metrics():
    from research.pipeline.stage_impls._paper_writing import _collect_raw_experiment_metrics
    return _collect_raw_experiment_metrics


def _get_review_compiled_pdf():
    from research.pipeline.stage_impls._paper_writing import _review_compiled_pdf
    ...
    *,
    ...
    if _rl20_path and _rl20_path.is_file():
        try:
            ...
            pass
    try:
        from research.pipeline.verified_registry import VerifiedRegistry as _VR20
...
def _load_seminal_papers_by_key() -> dict[str, dict]:
    ...
    """
    try:
        from research.data import _load_all as _load_seminal_all
...
def _execute_export_publish(
    ...
    *,
    ...
    try:
        ...
        try:
            from research.pipeline.paper_verifier import verify_paper as _verify_paper
            # BUG-222: Use best_only=True to validate against promoted best data only
            from research.pipeline.verified_registry import (
        ...
        try:
            ...
            from research.experiment.visualize import generate_all_charts
        ...
        try:
            ...
            if tex_path.exists():
                from research.templates.compiler import remove_missing_figures
        ...
        try:
            ...
            if _compile_result.success:
                ...
                try:
                    from research.templates.compiler import check_compiled_quality
...
def _execute_citation_verify(
    ...
    *,
    ...
    from research.literature.verify import parse_bibtex_entries
