...
def _execute_experiment_run(
    ...
    *,
    ...
    from research.experiment.factory import create_sandbox
...
def _execute_iterative_refine(
    ...
    *,
    ...
    from research.experiment.factory import create_sandbox
    from research.experiment.validator import format_issues_for_llm, validate_code
        ...
        if validation.ok and config.experiment.mode in ("sandbox", "docker"):
            ...
            if rerun.timed_out:
                ...
                if not rerun.metrics and rerun.stdout:
                    from research.experiment.sandbox import parse_metrics as _parse_sb_metrics
