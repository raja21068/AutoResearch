...
def _validate_draft_quality(
    ...
    *stage_dir*.
    """
    from research.prompts import SECTION_WORD_TARGETS, _SECTION_TARGET_ALIASES
    ...
    *,
    ...
    if exp_summary_text:
        ...
        if isinstance(exp_summary, dict):
            try:
                from research.pipeline.verified_registry import VerifiedRegistry
    ...
    if _verified_registry is not None:
        try:
            from research.templates.results_table_builder import (
...
"""
    ...
    try:
        from research.hitl.workshops.paper import PaperCoWriter
