...
from research.hardware import HardwareProfile, is_metric_name
...
def _get_evolution_overlay(
    ...
    *,
    ...
    if run_dir is not None:
        try:
            from research.evolution import EvolutionStore
...
def _collect_experiment_results(
    ...
    from research.experiment.sandbox import extract_paired_comparisons
...
def _multi_perspective_generate(
    ...
    *perspectives_dir* and returned as ``{role_name: response_text}``.
    """
    from research.prompts import _render  # noqa: PLC0415
